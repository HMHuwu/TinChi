          ...
          <div className="lg:col-span-2">
            <div className="bg-card border border-border rounded-lg p-6">
              ...
              <div className="space-y-6">
                ...
                <InputField label="Họ và tên" value={student.name} disabled />
                ...
                <InputField label="Ngành học" value={student.major} disabled />
                ...
                <div className="pt-4 border-t border-border">
                  <p className="text-sm text-muted-foreground mb-4">
                    Để cập nhật thông tin cá nhân, vui lòng liên hệ phòng đào
                    tạo hoặc gửi yêu cầu qua hệ thống.
                  </p>
