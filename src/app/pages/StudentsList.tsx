      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-muted-foreground">Danh sách toàn bộ sinh viên trong hệ thống</p>
          </div>
        ...
        <div className="bg-card border border-border rounded-lg p-6">
          ...
          <Table
            ...
            renderRow={(student) => (
              <tr key={student.id} className="hover:bg-secondary/50 transition-colors">
                <td className="px-6 py-4 text-sm text-primary">{student.code}</td>
          ...
          <div className="mt-4 flex items-center justify-between text-sm text-muted-foreground">
            <p>Hiển thị {filteredStudents.length} trong tổng số {students.length} sinh viên</p>
          </div>
        </div>
      </div>
    </Layout>
